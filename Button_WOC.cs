...
namespace ePOSOne.btnProduct
{
    ...
    {
        public Color _borderColor = Color.Silver;
        public Color _onHoverBorderColor = Color.Gray;
        public Color _buttonColor = Color.Red;
        public Color _onHoverButtonColor = Color.Yellow;
        public Color _textColor = Color.White;
        public Color _onHoverTextColor = Color.Gray;

        public bool _isHovering;
        public int _borderThickness = 6;
        public int _borderThicknessByTwo = 3;
